...
/* .... route catalogues ....  */
Route::namespace('backend')->prefix('/admin/catalogues')->group(function (){
    Route::get('/', 'EcataloguesController@index')->name('admin.catalogues');
    Route::get('/create','EcataloguesController@create')->name('admin.catalogues.create');
    Route::post('/store','EcataloguesController@store')->name('admin.catalogues.store');
});
