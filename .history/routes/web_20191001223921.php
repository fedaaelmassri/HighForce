...
Route::namespace('backend')->prefix('/admin/posts')->group(function (){
    ...
    Route::post('/delete/{id}', 'PostsController@delete')->name('admin.posts.delete');
...
Route::namespace('backend')->prefix('/admin/services')->group(function (){
    ...
    Route::post('/delete/{id}', 'ServicesController@delete')->name('admin.services.delete');
...
Route::namespace('backend')->prefix('/admin/ecatalogues')->group(function (){
    ...
    Route::post('/delete/{id}', 'EcataloguesController@delete')->name('admin.ecatalogues.delete');
