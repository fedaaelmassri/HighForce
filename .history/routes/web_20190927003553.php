...
Route::namespace('backend')->prefix('/admin/catalogues')->group(function (){
    Route::get('/', 'BrandsController@index')->name('admin.catalogues');
    Route::get('/create','BrandsController@create')->name('admin.catalogues.create');
    Route::post('/store','BrandsController@store')->name('admin.catalogues.store');
});
/* .... end brands route .... */
