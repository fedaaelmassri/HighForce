                    ...
                    <div class="section-title text-center">
                        <div class="row">
                            <div class="col-md-8 col-md-offset-2">
                                <h2 class="title text-uppercase line-bottom-double-line-centered">Our <span class="text-theme-colored">Services</span></h2>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="portfolio-filter font-alt align-center">
                                    ...
                                    <a href="#mechanical" class="" data-filter=".mechanical">Mechanical</a>
                                    <a href="#civil" class="" data-filter=".civil">Civil</a>
                                    <a href="#material" class="" data-filter=".material">Material</a>
                                    <a href="#chemical" class="" data-filter=".chemical">Chemical</a>
                                </div>
                                <!-- End Works Filter -->

                                <!-- Portfolio Gallery Grid -->
                                <div id="grid" class="gallery-isotope grid-4 gutter-20 clearfix">
                                    ...
                                    <!-- Portfolio Item Start -->
                                    <div class="gallery-item chemical">
                                        <div class="service-block mb-30">
                                            <img class="img-fullwidth" src="http://placehold.it/360x210" alt="">
                                    ...
                                    <!-- Portfolio Item Start -->
                                    <div class="gallery-item material">
                                        <div class="service-block mb-30">
                                            <img class="img-fullwidth" src="http://placehold.it/360x210" alt="">
