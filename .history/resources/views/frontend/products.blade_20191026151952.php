                ...
                success:function(data){
                    ...
                    $.each(data.categories,function(index,valu){
                        if(_id==valu.parent_id ){
                            output="&nbsp;&nbsp;&nbsp; "+valu.name
                            $("#childcat-"+id).append(
                                '  <li    class=" " > <a   data-toggle="collapse" href="javascript:void(0);" data-target="#childpcat-'+valu.id+'"  > <i  class="fa fa-angle-right"></i>'+ valu.name+'</a> <ul class="collapse" id="childpcat-'+valu.id+'"></ul> </li> '
