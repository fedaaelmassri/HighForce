...
@section('js')
 ...
 function viewByBraCat(bid){
    ...
    var braid=$("#braid").val();
    alert('braid'+braid);
    var url_m='productsByBraCat/'+cid+'=>'+null+'/'+bid;
                  ...
                  $("#braid").val(bid);
                    ...
                    $.each(data.categories,function(index,value){
                        $("#productsfilter").append(
                            ...
                            '<div class="product pb-0">'+
                            '<div class="product-thumb">'+
                            '<img alt="" src=src="'+base_url+'/storage/'+ value.image+'" width="320" heigt="360" class="img-responsive img-fullwidth">'+
                              '</div>'+
                                 '<div class="product-details text-center bg-lighter pt-15 pb-10">'+
