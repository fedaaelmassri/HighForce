                ...
                success:function(data){
                    ...
                    $.each(data.categories,function(index,valu){
                        if(_id==valu.parent_id ){
                            output="&nbsp;&nbsp;&nbsp; "+valu.name
                            $("#childcat-"+id).append(
                                '  <li  id="childpcat-'+valu.id +'"  class=" " > <a   data-toggle="collapse" href="javascript:void(0);" data-target="#childpcat-'+valu.id+'"  > <i  class="fa fa-angle-right"></i>'+ valu.name+'</a> <ul class="collapse" id="childpcat-'+valu.id+'"></ul> </li> '
				...
				output="&nbsp; &nbsp; &nbsp; -->"+valu.name
 				  $('#childpcat-'+id).append(
                    //  '<br/><input type="checkbox" name="vehicle3" value="'+valu.id+'" checked>'+output
                     '  <li  id="childppcat-'+valu.id +'"  class=" " > <i  class="fa fa-angle-right"></i><a   data-toggle="collapse" href="javascript:void(0);" data-target="#childppcat-'+valu.id+'"  > '+ valu.name+'</a> <ul class="collapse" id="childppcat-'+valu.id+'"></ul> </li> '
