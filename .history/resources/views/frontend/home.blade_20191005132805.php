        ...
        <div class="section-content">
          ...
          @foreach (App\Services::take(6)->get() as  $service)
            ...
            <div class="col-sm-6 col-md-4 maxwidth500 mb-40 wow fadeInLeft" data-wow-duration="1s" data-wow-delay="0.1s">
              ...
              <a href="{{route('service-details' , [ 'id' => $service->id ])}}" class="btn btn-sm btn-theme-colored">Read more</a>
            </div>
            @endforeach
                                ...
                                <div class="item">
                                    <div class="team-members maxwidth400">
                                        <div class="team-thumb">
                                            <img src="{{asset('storage/'.$brand->image) }}" alt="" class="img-fullwidth">
                                        </div>
                                ...
                                @foreach (App\Posts::all() as  $post)
                                    <div class="item">
                                        <article class="post clearfix mb-sm-30">
                                            ...
                                            <div class="entry-content p-20">
                                                <h4 class="entry-title text-white text-uppercase line-bottom pb-5"><a class="font-weight-600" href="blog-single-left-sidebar.html">{{$post->name}}</a></h4>
                                                <!-- <div class="entry-meta">
                                                    <ul class="list-inline font-12 mb-10">
                                                        <li><i class="fa fa-user text-theme-colored mr-5"></i>By: Author / </li>
                                                        <li><i class="fa fa-calendar text-theme-colored mr-5"></i> June 26, 2016 </li>
                ...
                <div class="container pt-0 pb-0">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="item">
                                    <a href="#"><img src="{{asset('storage/'.$brand->image) }}" alt=""></a>
                                </div>
                                @endforeach
