...
<section>
  ...
  <div class="row">
              <div class="col-xs-6 col-md-3"> <a class="thumbnail" href="#"> <img alt="..." src="https://placehold.it/200x200" class="img-fullwidth"> </a>
              <a class="btn btn-colored btn-flat active  pb-10"   href="{{route('ecatalog')}}">E-Catalog</a>
