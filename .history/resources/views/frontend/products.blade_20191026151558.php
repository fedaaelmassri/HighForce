                ...
                success:function(data){
                    ...
                    $.each(data.categories,function(index,valu){
                        if(_id==valu.parent_id ){
                            output="&nbsp;&nbsp;&nbsp; "+valu.name
                            $("#childcat-"+id).append(
                                '  <li  id="childpcat-'+valu.id +'"  class=" " > <i  class="fa fa-angle-right"></i><a   data-toggle="collapse" href="javascript:void(0);" data-target="#childpcat-'+valu.id+'"  > '+ valu.name+'</a> <ul class="collapse" id="childpcat-'+valu.id+'"></ul> </li> '
