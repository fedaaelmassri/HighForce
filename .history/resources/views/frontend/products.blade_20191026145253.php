                       ...
                       $.each(data.categories,function(index,valu){
                        if(valu.parent_id==0   ){
                          	$('#catlist').append(
                                     ...
                                     '  <li   class=" " ><a   data-toggle="collapse" href="javascript:void(0);" data-target="#childcat-'+valu.id+'"  > '+ valu.name+'</a> <ul class="collapse" id="childcat-'+valu.id+'"></ul> </li> '
                ...
                success:function(data){
                    ...
                    $.each(data.categories,function(index,valu){
                        if(_id==valu.parent_id ){
                            output="&nbsp;&nbsp;&nbsp; "+valu.name
                            $("#childcat-"+id).append(
                                '  <li  id="childpcat-'+valu.id +'"  class=" " > <i  class="fa fa-angle-right"></i><a   data-toggle="collapse" href="javascript:void(0);" data-target="#childpcat-'+valu.id+'"  > '+ valu.name+'</a> <ul class="collapse" id="childppcat-'+valu.id+'"></ul> </li> '
				...
				output="&nbsp; &nbsp; &nbsp; -->"+valu.name
 				  $('#childppcat-'+id).append(
                    //  '<br/><input type="checkbox" name="vehicle3" value="'+valu.id+'" checked>'+output
                     '  <li  id="childppcat-'+valu.id +'"  class=" " > <i  class="fa fa-angle-right"></i><a   data-toggle="collapse" href="javascript:void(0);" data-target="#childppcat-'+valu.id+'"  > '+ valu.name+'</a> <ul class="collapse" id="childpppcat-'+valu.id+'"></ul> </li> '

                      );
			 }
			if(_id3==valu.parent_id  && x==0){x=1;
			// output2=" &nbsp;  &nbsp; &nbsp; &nbsp; &nbsp;"+valu.name;
				  $('#childpppcat-'+id).append(
            '  &nbsp; &nbsp  <li  id="childpppcat-'+valu.id +'"  class=" " > <i  class="fa fa-angle-right"></i><a   data-toggle="collapse" href="javascript:void(0);" data-target="#childpppcat-'+valu.id+'"  > '+ valu.name+'</a>   </li> '
                         );
			}
