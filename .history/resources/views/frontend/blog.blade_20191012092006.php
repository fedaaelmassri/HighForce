              ...
              <div class="col-md-12">
                <div class="row list-dashed">
                  ...
                  <article class="post clearfix mb-50 pb-30 bg-lighter">
                    <div class="entry-header">
                      <div class="post-thumb">
                        <div class="fluid-width-video-wrapper" style="padding-top: 56.9444%;"><iframe src="//player.vimeo.com/video/114959015?title=0&amp;byline=0&amp;portrait=0" allowfullscreen="" id="fitvid0">
                        </iframe></div>
                      </div>
                    </div>
                    <div class="entry-content p-20 pr-10">
                  ...
                  <article class="post clearfix mb-50 pb-30 bg-lighter">
                    <div class="entry-header">
                      <div class="post-thumb">
                        <div class="fluid-width-video-wrapper" style="padding-top: 56.6667%;"><iframe src="http://www.youtube.com/embed/oIDqz2BrVec?autoplay=0" allowfullscreen="" id="fitvid1">
                        </iframe></div>
                      </div>
                    </div>
                    <div class="entry-content p-20 pr-10">
                  ...
                  <article class="post clearfix mb-50 pb-30 bg-lighter">
                    <div class="entry-header">
                      <div class="post-thumb">
                        ...
                        <div class="gallery-isotope grid-5 masonry gutter-small clearfix" data-lightbox="gallery" style="position: relative; height: 382.875px;">
                          ...
                          <!-- Portfolio Item Start -->
                          <div class="gallery-item wide" style="position: absolute; left: 169px; top: 0px;">
                            <a href="http://placehold.it/800x600" data-lightbox="gallery-item" title="Title Here 2"><img src="http://placehold.it/800x600" alt=""></a>
                          </div>
                          <!-- Portfolio Item End -->

                          <!-- Portfolio Item Start -->
                          <div class="gallery-item" style="position: absolute; left: 508px; top: 0px;">
                            <a href="http://placehold.it/400x300" data-lightbox="gallery-item" title="Title Here 3"><img src="http://placehold.it/400x300" alt=""></a>
                          </div>
                          <!-- Portfolio Item End -->

                          <!-- Portfolio Item Start -->
                          <div class="gallery-item" style="position: absolute; left: 678px; top: 0px;">
                            <a href="http://placehold.it/400x600" data-lightbox="gallery-item" title="Title Here 4"><img src="http://placehold.it/400x600" alt=""></a>
                          </div>
                          <!-- Portfolio Item End -->

                          <!-- Portfolio Item Start -->
                          <div class="gallery-item" style="position: absolute; left: 0px; top: 127px;">
                            <a href="http://placehold.it/400x600" data-lightbox="gallery-item" title="Title Here 5"><img src="http://placehold.it/400x600" alt=""></a>
                          </div>
                          <!-- Portfolio Item End -->

                          <!-- Portfolio Item Start -->
                          <div class="gallery-item" style="position: absolute; left: 508px; top: 127px;">
                            <a href="http://placehold.it/400x300" data-lightbox="gallery-item" title="Title Here 6"><img src="http://placehold.it/400x300" alt=""></a>
                          </div>
                          <!-- Portfolio Item End -->

                          <!-- Portfolio Item Start -->
                          <div class="gallery-item" style="position: absolute; left: 678px; top: 253px;">
                            <a href="http://placehold.it/400x300" data-lightbox="gallery-item" title="Title Here 6"><img src="http://placehold.it/400x300" alt=""></a>
                          </div>
                          <!-- Portfolio Item End -->

                          <!-- Portfolio Item Start -->
                          <div class="gallery-item" style="position: absolute; left: 169px; top: 254px;">
                            <a href="http://placehold.it/400x300" data-lightbox="gallery-item" title="Title Here 6"><img src="http://placehold.it/400x300" alt=""></a>
                          </div>
                          <!-- Portfolio Item End -->

                          <!-- Portfolio Item Start -->
                          <div class="gallery-item" style="position: absolute; left: 339px; top: 254px;">
                            <a href="http://placehold.it/400x300" data-lightbox="gallery-item" title="Title Here 6"><img src="http://placehold.it/400x300" alt=""></a>
                          </div>
                          <!-- Portfolio Item End -->

                          <!-- Portfolio Item Start -->
                          <div class="gallery-item" style="position: absolute; left: 508px; top: 255px;">
                            <a href="http://placehold.it/400x300" data-lightbox="gallery-item" title="Title Here 6"><img src="http://placehold.it/400x300" alt=""></a>
                          </div>
                          <!-- Portfolio Item End -->
                        </div>
                  ...
                  <article class="post clearfix mb-50 pb-30 bg-lighter">
                    <div class="entry-header">
                      <div class="post-thumb">
                        ...
                        <div class="owl-stage-outer"><div class="owl-stage" style="transform: translate3d(-1696px, 0px, 0px); transition: all 0.25s ease 0s; width: 4240px;"><div class="owl-item cloned" style="width: 848px; margin-right: 0px;"><div class="item">
                            <img src="https://placehold.it/900x500" alt="">
                          </div></div><div class="owl-item" style="width: 848px; margin-right: 0px;"><div class="item">
                            <img src="https://placehold.it/900x500" alt="">
                          </div></div><div class="owl-item active" style="width: 848px; margin-right: 0px;"><div class="item">
                            <img src="https://placehold.it/900x500" alt="">
                          </div></div><div class="owl-item" style="width: 848px; margin-right: 0px;"><div class="item">
                            <img src="https://placehold.it/900x500" alt="">
                          </div></div><div class="owl-item cloned" style="width: 848px; margin-right: 0px;"><div class="item">
                            <img src="https://placehold.it/900x500" alt="">
          ...
          <div class="col-sm-12 col-md-3">
            <div class="sidebar sidebar-right mt-sm-30">
              ...
              <div class="widget">
                ...
                <div class="twitter-feed-carousel dots-left" data-username="Envato" data-count="3"><span>Loading!</span></div>
              </div>
              <div class="widget">
                ...
                <div class="owl-stage-outer"><div class="owl-stage" style="transform: translate3d(-526px, 0px, 0px); transition: all 0.25s ease 0s; width: 1315px;"><div class="owl-item cloned" style="width: 263px; margin-right: 0px;"><div class="item">
                  ...
                  </div></div><div class="owl-item" style="width: 263px; margin-right: 0px;"><div class="item">
                    <img src="https://placehold.it/365x230" alt="">
                    <h4 class="title">This is a Demo Title</h4>
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Molestiae illum amet illo.</p>
                  </div></div><div class="owl-item active" style="width: 263px; margin-right: 0px;"><div class="item">
                    <img src="https://placehold.it/365x230" alt="">
                    <h4 class="title">This is a Demo Title</h4>
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Molestiae illum amet illo.</p>
                  </div></div><div class="owl-item" style="width: 263px; margin-right: 0px;"><div class="item">
                    ...
                    <h4 class="title">This is a Demo Title</h4>
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Molestiae illum amet illo.</p>
                  </div></div><div class="owl-item cloned" style="width: 263px; margin-right: 0px;"><div class="item">
                    <img src="https://placehold.it/365x230" alt="">
                    <h4 class="title">This is a Demo Title</h4>
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Molestiae illum amet illo.</p>
                  </div></div></div></div><div class="owl-controls"><div class="owl-nav"><div class="owl-prev" style="display: none;"><i class="pe-7s-angle-left"></i></div><div class="owl-next" style="display: none;"><i class="pe-7s-angle-right"></i></div></div><div class="owl-dots" style="display: none;"></div></div></div>
