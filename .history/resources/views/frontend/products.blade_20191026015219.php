            ...
            <h5 class="widget-title line-bottom">Categories</h5>
                            ...
                            <div class="services-list">
                                <ul class="list mt-0" id="catlist">
                                    ...
                                    <li class="{{$categories->id==$allcat->id ? 'active' : ''}}"><a href="{{route('product_details' , [ 'id' => $allcat->id ])}}"> {{$allcat->name}}</a></li>
 		 ...
 		 $.each(data.categories,function(index,valu){
 			 if(valu.parent_id==0   ){
 				$('#catlist').append(
                  ...
                  '  <li class="'+{{$categories->id==value->id ? 'active' : ''}}+'"><a href="'+{{route('product_details' , [ 'id' => valu->id ])}}+'">'+ valu.name+'</a></li>'
