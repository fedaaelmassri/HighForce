                  ...
                  var x=0;
                   ...
                   alert('success');
                       $.each(data.categories,function(index,valu){
                        if(valu.parent_id==0   ){
                          	$('#catlist').append(
                                     '  <li class=" "><a href=" ">'+ valu.name+'</a></li>'
                ...
                success:function(data){
                    $.each(data.categories,function(index,valu){
                        ...
                        if(_id==valu.parent_id ){
                            output="&nbsp;&nbsp;&nbsp; ->"+valu.name
                            $('#catlist').append(
                                '<input type="checkbox" name="vehicle3" value="'+valu.id+'" checked>'+output
 ...
 function get2(){
	 ...
	 success:function(data){
		 $.each(data.categories,function(index,valu){
			...
			output2=" &nbsp;  &nbsp; &nbsp; &nbsp; &nbsp;--->"+valu.name;
				  $('#catlist').append(
                    '<input type="checkbox" name="vehicle3" value="'+valu.id+'" checked>'+output2+'<br>'
                         );
			}
