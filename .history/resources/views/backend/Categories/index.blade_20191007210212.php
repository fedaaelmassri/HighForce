                        ...
                        @foreach($categories as $category)
                            <tr role="row" class="odd">
                                ...
                                <td nowrap="">
                                    ...
                                    <a href="{{route('admin.category.delete','[ 'id' => $category->id ]')}}" class="m-portlet__nav-link btn m-btn m-btn hover-danger m-btn--icon m-btn--icon-only m-btn--pill sa-remove deleteRecored" id="{{$category->id}}"> <i class="la la-trash"></i>
                                    </a>
