        ...
        <div class="kt-portlet__head-toolbar">
            <div class="kt-portlet__head-wrapper">
                <div class="kt-portlet__head-actions">
                    ...
                    &nbsp;
                    <a href="{{route('admin.brands.create')}}" class="btn btn-brand btn-elevate btn-icon-sm">
                    ...
                    <table class="table  table-hover table-checkable dataTable no-footer dtr-inline" id="kt_table_1" role="grid" aria-describedby="kt_table_1_info" style="width: 992px;">
                        ...
                        <tbody>
                            ...
                            <tr role="row" class="odd">
                                ...
                                <td><img src="{{asset('storage/' . $brand->image )}}" height="40" width="50"></td>
                                <td nowrap="">

<a href="{{route('admin.brands.edit' , [ 'id' => $brand->id ])}}" class="m-portlet__nav-link btn m-btn m-btn--hover-danger m-btn--icon m-btn--icon-only m-btn--pill" title="Edit"> <i class="la la-edit"></i>
</a>

<a href="#" class="m-portlet__nav-link btn m-btn m-btn hover-danger m-btn--icon m-btn--icon-only m-btn--pill sa-remove deleteRecored"  id="{{$brand->id}}"> <i class="la la-trash"></i>
</a>
</td>
                            </tr>
 ...
 <div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            ...
            <div class="modal-content">
                ...
                <p>Are you Sure do you want delete The Brand.</p>
                </div>
