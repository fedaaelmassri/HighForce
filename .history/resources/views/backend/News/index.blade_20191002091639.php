        ...
        <div class="kt-portlet__head-toolbar">
            <div class="kt-portlet__head-wrapper">
                <div class="kt-portlet__head-actions">
                    ...
                    &nbsp;
                    <a href="{{route('admin.news.create')}}" class="btn btn-brand btn-elevate btn-icon-sm">
                    ...
                    <table class="table  table-hover table-checkable dataTable no-footer dtr-inline" id="kt_table_1" role="grid" aria-describedby="kt_table_1_info" style="width: 992px;">
                        ...
                        <tbody>
                            ...
                            <tr role="row" class="odd">
                                <td class="sorting_1" tabindex="0">{{$new->id}}</td>
                                <td>{{$new->name}}</td>
                                <td>{{$new->description}}</td>
                                <td><img src="{{asset('storage/' . $new->image )}}" height="40" width="50"></td>
                                <td nowrap="">

                                    <a href="{{route('admin.news.edit' , [ 'id' => $new->id ])}}" class="m-portlet__nav-link btn m-btn m-btn--hover-danger m-btn--icon m-btn--icon-only m-btn--pill" title="Edit"> <i class="la la-edit"></i>
                                    </a>

                                    <a href="#" class="m-portlet__nav-link btn m-btn m-btn hover-danger m-btn--icon m-btn--icon-only m-btn--pill sa-remove deleteNews"  id="{{$new->id}}"> <i class="la la-trash"></i>
                                    </a>
        ...
        <div class="modal-dialog" role="document">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">News Delete</h5>
                ...
                <p>Are you Sure do you want delete News.</p>
                </div>
                <div class="modal-footer">
                    <button class="btn btn-primary deleteNewsBtn">Save</button>
