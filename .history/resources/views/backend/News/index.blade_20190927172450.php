...
<a href="#" class="m-portlet__nav-link btn m-btn m-btn hover-danger m-btn--icon m-btn--icon-only m-btn--pill sa-remove" data-id="{{$new->id}}"> <i class="la la-trash"></i>
</a>
...
var url='{{URL::to('/admin/news/delete')}}' ;
   alert(url);
