...
<a href="#" class="m-portlet__nav-link btn m-btn m-btn hover-danger m-btn--icon m-btn--icon-only m-btn--pill sa-remove deleteRecored" data-id="{{$service->id}}" onclick="deleteConfirmation({{$service->id}})"> <i class="la la-trash"></i>
</a>
...
function deleteConfirmation(id) {
    //var id = $(this).data('id');
    alert(id);
    //var url='{{URL::to('/admin/services/delete')}}/'+ id ;
    var url="{{url('/admin/services/delete')}}/" + id;
    alert(url);
        swal({
            title: "Delete?",
 ...
 // swal({   title: "Auto close alert!",   text: "I will close in 1 seconds.",   timer: 1000,   showConfirmButton: false })", "error");
}
else{
