...
<a href="#" class="m-portlet__nav-link btn m-btn m-btn hover-danger m-btn--icon m-btn--icon-only m-btn--pill sa-remove" data-id="{{$service->id}}" onclick="deleteConfirmation({{$user->id}})"> <i class="la la-trash"></i>
</a>
