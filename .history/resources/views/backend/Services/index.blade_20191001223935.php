...
<a href="#" class="m-portlet__nav-link btn m-btn m-btn hover-danger m-btn--icon m-btn--icon-only m-btn--pill sa-remove deleteRecored" id="{{$service->id}}" onclick="deleteConfirmation({{$service->id}})"> <i class="la la-trash"></i>
</a>
