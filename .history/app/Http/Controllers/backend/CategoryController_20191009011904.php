...
public function editparentCat($id)
{
    ...
    //if found
        ...
        //if edit success
           if($parentCategory ){
            return response()->json(['message' => sprintf('The Category: "%s" Deleeted success !', $Category->name)]);
        }
                //if edit error
        else{
            return response()->json(['message' => sprintf('Error Deleeted!', $Category->name)]);
     ...
     //if not parent category
        ...
        //if error delete
            ...
            return response()->json(['message' => sprintf('Error Deleted!', $Category->name)]);
