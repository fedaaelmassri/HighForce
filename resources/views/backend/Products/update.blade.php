...
<div class="kt-content  kt-grid__item kt-grid__item--fluid" id="kt_content">
    ...
    <!--begin::Form-->
        ...
        <form method="post" action="{{route('admin.products.update', [ 'id' => $products->id ])}}" enctype="multipart/form-data" class="kt-form kt-form--label-right">
                      @method('PUT')
                        @csrf
...
@enderror
                    ...
                    @enderror
                        ...
                        <img class="image " src="{{ asset('storage/' . $products->image) }}" height="100"  >
                    </div>
