        ...
        <div class="kt-portlet__head-toolbar">
            <div class="kt-portlet__head-wrapper">
                <div class="kt-portlet__head-actions">
                    ...
                    &nbsp;
                    <a href="{{route('admin.aboutUs.create')}}" class="btn btn-brand btn-elevate btn-icon-sm">
                    ...
                    <table class="table table-striped- table-bordered table-hover table-checkable dataTable no-footer dtr-inline" id="kt_table_1" role="grid" aria-describedby="kt_table_1_info" style="width: 992px;">
                        ...
                        <tbody>
                            ...
                            <tr role="row" class="odd">
                                <td class="sorting_1" tabindex="0">{{$about->id}}</td>
                                <td>{{$about->name}}</td>
                                ...
                                <td nowrap="">
                                    ...
                                    <a href="{{route('admin.aboutUs.edit', [ 'id' => $about->id ])}}" class="m-portlet__nav-link btn m-btn m-btn--hover-danger m-btn--icon m-btn--icon-only m-btn--pill" title="Edit"> <i class="la la-edit"></i>
                                    </a>

                                    <a href="#" class="m-portlet__nav-link btn m-btn m-btn hover-danger m-btn--icon m-btn--icon-only m-btn--pill sa-remove deleteAbouts" id="{{$about->id}}"> <i class="la la-trash"></i>
                                    </a>
...
<!--end::Page Vendors -->
 ...
 <!-- Modal -->
 <div class="modal fade" id="deleteAboutsModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">About Delete</h5>
                ...
                <p>Are you Sure do you want delete Abouts.</p>
                </div>
                <div class="modal-footer">
                    <button class="btn btn-primary deleteAboutBtn">Save</button>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $(document).on("click", '.deleteAbouts', function() {
            var about_id = this.id;
            // alert(news_id);
            // console.log(news_id);
            $("#id").val(about_id);
            current_location = $(this);
            $('#deleteAboutsModal').modal('show');
        });
